...
-->
  ...
  <body>
	<%ArrayList<Bean> al = new ViewDAO().spViewUserFileRequest(); %>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
        <div class="jumper">
            <div></div>
        ...
        <div class="row">
          ...
          <div class="col-md-12" align="center" style="margin-left: 2%;">
            <div class="contact-form">
              ...
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Uid</th>
              ...
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Create Index</th>
              </tr>
              <%for(Bean b: al){ %>
              <tr>
              	...
              	<td style="color: black; font-family: Times New Roman; padding: 5px;"><a href="./CreateIndexServlet_sp?fid=<%=b.getUid()%>"><%=b.getPkey() %></a></td>
              </tr>
              <%} %>
              </table>
            </div>
          ...
          <%}else
          {%>
        	  <h2 style="margin-left: 30%;"><em>User Data Not Available</em></h2>
          <%} %>
        </div>
      </div>
    </div>
