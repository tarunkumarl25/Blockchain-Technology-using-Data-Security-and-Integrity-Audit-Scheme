...
-->
  ...
  <body>
	...
	ArrayList<Bean> al = new ViewDAO().tpaViewAuditFiles(tpaid); %>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
        <div class="jumper">
            <div></div>
        ...
        <div class="row">
          ...
          <div class="col-md-12" align="center" style="margin-left: 2%;">
            <div class="contact-form">
              ...
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Publish Result</th>
              </tr>
              <%for(Bean b: al){ %>
              <tr>
              	...
              	<td style="color: black; font-family: Times New Roman; padding: 5px;"><a href="./PublishResultServlet_tpa?aid=<%=b.getUid()%>&fid=<%=b.getFid()%>"><%=b.getHashcode() %></a></td>
              </tr>
              <%} %>
              </table>
            </div>
          ...
          <%}else
          {%>
        	  <h2 style="margin-left: 30%;"><em>Audit Files are Available</em></h2>
          <%} %>
        </div>
      </div>
    </div>
