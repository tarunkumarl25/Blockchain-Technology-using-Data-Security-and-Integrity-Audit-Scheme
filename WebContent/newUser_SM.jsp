...
-->
  ...
  <body>
	<%ArrayList<Bean> al = new ViewDAO().smViewUserRequest(); %>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
        <div class="jumper">
            <div></div>
        ...
        <div class="row">
          ...
          <div class="col-md-12" align="center" style="margin-left: 2%;">
            <div class="contact-form">
              ...
              <th style="color: black; font-family: Times New Roman; padding: 20px;">Activate</th>
              </tr>
              <%for(Bean b: al){ %>
              <tr>
              	...
              	<td style="color: black; font-family: Times New Roman; padding: 20px;"><a href="./ActivateNewUserServlet_SM?uid=<%=b.getUid()%>">Activate</a></td>
              </tr>
              <%} %>
              </table>
            </div>
          ...
          <%}else
          {%>
        	  <h2 style="margin-left: 25%;"><em>New User Requests are Not Available</em></h2>
          <%} %>
        </div>
      </div>
    </div>
