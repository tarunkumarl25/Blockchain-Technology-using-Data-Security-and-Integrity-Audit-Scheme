...
-->
  ...
  <body>
	<%ArrayList<Bean> al = new ViewDAO().spViewAuditFiles(); %>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
        <div class="jumper">
            <div></div>
        ...
        <div class="row">
          ...
          <div class="col-md-12" align="center" style="margin-left: 2%;">
            <div class="contact-form">
              ...
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Send Integrity Proof</th>
              </tr>
              <%for(Bean b: al){ %>
              <tr>
              	...
              	<td style="color: black; font-family: Times New Roman; padding: 5px;"><a href="./SendIntegrityProofServlet_sp?aid=<%=b.getUid()%>"><%=b.getHashcode() %></a></td>
              </tr>
              <%} %>
              </table>
            </div>
