...
-->
  ...
  <body>
	<%ArrayList<Bean> al = new ViewDAO().smViewTPA(); %>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
        <div class="jumper">
            <div></div>
        ...
        <div class="row">
          ...
          <div class="col-md-6" align="center" style="margin-left: 25%;">
            <div class="contact-form">
              ...
              <tr>
              <th style="color: black; font-family: Times New Roman; padding: 20px;">TID</th>
              <th style="color: black; font-family: Times New Roman; padding: 20px;">TPA Name</th>
          ...
          <%}else
          {%>
        	  <h2 style="margin-left: 25%;"><em>TPA's are Not Available</em></h2>
          <%} %>
        </div>
      </div>
    </div>
