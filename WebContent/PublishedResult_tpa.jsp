...
-->
  ...
  <body>
	<%
	int tpaid = (Integer)session.getAttribute("tid");
	ArrayList<Bean> al = new ViewDAO().tpaViewPublishedFiles(tpaid); %>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
        <div class="jumper">
            <div></div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2><em>View Published Data</em></h2>
          ...
          <div class="col-md-12" align="center" style="margin-left: 2%;">
            <div class="contact-form">
              ...
              <tr>
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Audit Id</th>
              ...
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Audit Log</th>
              <th style="color: black; font-family: Times New Roman; padding: 5px;">HashValue</th>
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Hash Code</th>
              </tr>
              <%for(Bean b: al){ %>
              <tr>
              	<td style="color: black; font-family: Times New Roman; padding: 5px;"><%=b.getUid() %></td>
          ...
          <%}else
          {%>
        	  <h2 style="margin-left: 30%;"><em>Published Files are Available</em></h2>
          <%} %>
        </div>
      </div>
    </div>
