...
-->
  ...
  <body>
	...
	ArrayList<Bean> al = new ViewDAO().userViewDuplicateData(uid); %>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
        <div class="jumper">
            <div></div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2><em>Check for Duplicates</em></h2>
          ...
          <div class="col-md-12" align="center" style="margin-left: 2%;">
            <div class="contact-form">
              ...
              <th style="color: black; font-family: Times New Roman; padding: 5px;">Send for Ownership</th>
              </tr>
              <%for(Bean b: al){ %>
              <tr>
              	...
              	<td style="color: black; font-family: Times New Roman; padding: 5px;"><a href="./DuplicateFileSendtoSPServlet_user?fid=<%=b.getFid()%>">Send to SP</a></td>
              </tr>
              <%} %>
              </table>
            </div>
